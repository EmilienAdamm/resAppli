...
if (isset($_POST['reg_user'])) {
  ...
  $telFix = mysqli_real_escape_string($db, $_POST['telFix']);
  $telPortable = mysqli_real_escape_string($db, $_POST['telMobile']);
...
if (isset($_POST['login_user'])) {
  ...
  if (count($errors) == 0) {
  	...
  	$query = "SELECT * FROM users WHERE USERRsocial='$username' AND USERPassWord='$password'";
